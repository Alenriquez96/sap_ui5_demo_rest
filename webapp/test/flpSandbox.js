		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapui5demorest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapui5demorest-display": {
								"semanticObject": "comsapui5demorest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ui5demorest",
									"url": sap.ui.require.toUrl("com/sap/ui5demorest")
								}
							}
						}
					}
